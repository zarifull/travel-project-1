...
function Home() {
  return (
            ...
            <div className="booking-block">
              <div className="booking-box">
                <div className="selects select1">
                  ...
                  <input type='text' placeholder='Where to ?' className="bValue booking-inp" />
              </div>
              <div className="selects select2">
                  <i className="fa-solid booking-icons select-icon2 fa-calendar-days"></i>
                  <label htmlFor='date' className="label">Date</label>
                  <input type='date'  className="bValue booking-date" placeholder='DD/MM/YYYY' />
              </div>
              <div className="selects select3">
                  <i className="fa-solid booking-icons fa-suitcase-rolling"></i>
                  <label htmlFor='guests' className="label">Guets</label>
                  <input type='number' placeholder='2 adults' min="1" className="bValue booking-guests" />
              </div>
    ...
    {/* <div className="home-block">
      ...
      <div className="home-boxes home-box1">
        <div className="part1">
          <img className='boxImgFirst' src={turkey1} alt="" />
          <img className='boxImgSecond' src={turkey2} alt="" />
        </div>

        <div className="part2">
          <p className='parts-prg'>See Rome and its architectural wonders</p>
          <p className='parts-prg2'>
          Nunc ullamcorper faucibus eu nullam at. Blandit sed vel dolor 
          tortor ultrices risus mattis faucibus eu. Massa sit aliquet diam 
          nullam sed ipsum. Dignissim lacus ac amet egestas.
          </p> 
          <div className="parts-link"><Link className='parts-link' to='/' >
          Discover Rome  <i class="fa-solid fa-arrow-right"></i>
          </Link></div>
        </div>
      </div> */}

              {/* <div className="home-boxes home-box2">
              <div className="part3">
                  <p className='parts-prg'>See Rome and its architectural wonders</p>
                  <p className='parts-prg2  '>
                  Nunc ullamcorper faucibus eu nullam at. Blandit sed vel dolor 
                  ...
                  <div className="parts-link"><Link className='parts-link' to='/' >
                  Discover Rome  <i className="fa-solid fa-arrow-right"></i>
                  </Link></div>
                </div>
                <div className="part4">
                  <img className='boxImgthird' src={hoteLake2} alt="" />
                  <img className='boxImgFourth' src={hoteLake1} alt="" />
                </div>
              </div>

                    <div className="home-boxes home-box3">
                      <div className="part1">
                        <img className='boxImgFiveth' src={tashkent1} alt="" />
                        <img className='boxImgSixth' src={tashkent2} alt="" />
                      </div>
